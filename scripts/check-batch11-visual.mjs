...
['Opening preference is device-local and non-authoritative',files.opening.includes('localStorage')&&files.opening.includes('securepay.market.handshake.seen.v2')&&files.opening.includes('No auth or financial data is stored here')],
['Opening is identity-scoped and long-return aware',files.opening.includes('traderKey')&&files.opening.includes('LONG_RETURN_INTERVAL_MS')],
